        ...
        <Fragment>
            <div className='portfolio-card' >
                ...
                <animated.div className={`card-content ${contentClass}`}>
                    <span className='project-name'>{props.name}</span><span onClick={toggleCard}><IoMdClose className='close-project'/></span>
                    <p>{props.description}</p>
                    <p className='highlight'>skill highlight: {props.skillHighlight}</p>
                    <a href={props.website}>website</a> | <a href={props.gitHubLink}>code</a>
                </animated.div>
            </div>
        </Fragment>
    )
